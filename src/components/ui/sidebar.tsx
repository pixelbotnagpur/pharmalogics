...
>(({ className, ...props }, ref) => {
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        "h-8 w-full bg-background focus-visible:outline-none",
        className
      )}
      {...props}
    />
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-light text-sidebar-foreground/70 outline-none transition-[margin,opa] ease-linear focus-visible:outline-none [&>svg]:size-4 [&>svg]:shrink-0",
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "absolute right-1 top-1/2 -translate-y-1/2 flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-xs font-light tabular-nums text-sidebar-foreground select-none pointer-events-none",
