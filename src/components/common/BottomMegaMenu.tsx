...
export function BottomMegaMenu() {
  ...
  return (
    <div
      className="fixed bottom-0 inset-x-0 z-0 h-screen flex flex-col justify-end"
    >
        <Image
        ...
        <div className="relative z-10 overflow-y-auto max-h-full">
            <div className="container mx-auto px-4 pt-8 pb-4">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-6 gap-4">
                    <span className="font-headline text-3xl md:text-4xl font-normal text-white">Explore Our Solutions</span>
                        ...
                        <Card className="overflow-hidden h-full bg-black/20 rounded-lg border-0 shadow-none group-hover/button:bg-black/40 transition-colors">
                            <CardContent className="p-5 flex flex-col gap-5 h-full">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className={cn(
                                        "flex-shrink-0 rounded-md h-7 w-7 md:h-8 md:w-8 flex items-center justify-center bg-accent text-accent-foreground transition-colors duration-300",
                                ...
                                <div className="space-y-1.5">
                                    <h4 className="font-headline text-lg md:text-xl font-normal text-white leading-tight">{category.name}</h4>
                                    <p className="text-[9px] md:text-[10px] text-white/80 uppercase tracking-widest leading-relaxed">
                ...
                <p className="text-center text-[10px] text-primary-foreground/70 mt-6 px-4 leading-relaxed">
